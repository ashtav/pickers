                ...
                child: AnimatedOpacity(
                  ...
                  child: number == 0
                      ...
                      : Container(
                          ...
                          decoration: BoxDecoration(color: theme.colorScheme.secondary, shape: BoxShape.circle, border: Br.all(Colors.white)),
                          padding: Ei.all(number > 9 ? 3.0 : 7.0),
                          child: Text('$number', style: PickerConstant.style.copyWith(color: Colors.white, fontSize: 14)),
                        ),
                ),
              ))
            ],
