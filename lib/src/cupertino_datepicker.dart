...
import 'constant_picker.dart';
import 'notifier/date_picker_notifier.dart';
...
class CupertinoDatePickerWidget extends StatelessWidget {
  ...
  const CupertinoDatePickerWidget(
      {super.key, this.initialDate, this.firstDate, this.lastDate, this.confirmLabel, this.useShortMonths = false, this.alignment});
  ...
  Widget build(BuildContext context) {
    ...
    List<String> months = PickerConstant.months.map((e) => useShortMonths ? e.substring(0, 3) : e).toList();
    ...
    DatePickerNotifier notifier = DatePickerNotifier({'month': months[init.month], 'year': init.year});
                  ...
                  child: SizedBox(
                    ...
                    child: Intrinsic(
                      children: List.generate(3, (t) {
                        String value = ['date', 'month', 'year'][t];
                        return Expanded(
                ...
                return Align(
                  ...
                  child: Padding(
                    ...
                    child: ZoomIn(
                      child: Text(
                        items[index],
                        style: PickerConstant.style.copyWith(
